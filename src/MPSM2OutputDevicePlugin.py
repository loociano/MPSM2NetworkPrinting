...
## This plugin enables network interoperability with Monoprice Select Mini V2 printers.
class MPSM2OutputDevicePlugin(OutputDevicePlugin):
    ...
    def __init__(self) -> None:
        ...
        self._device_manager.discoveredDevicesChanged.connect(self.discoveredDevicesChanged)
    ...
    def startDiscovery(self) -> None:
        self._device_manager.startDiscovery()

    # Overrides
    def refreshConnections(self) -> None:
        self._device_manager.refreshConnections()
    ...
    def addManualDevice(self, address: str, callback: Optional[Callable[[bool, str], None]] = None) -> None:
        self._device_manager.addManualDevice(address, callback)
